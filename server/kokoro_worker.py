...
class Worker:
    ...
    def initialize(self, model_name, voice):
        ...
        try:
            ...
            if model_name == "prince-canuma/Kokoro-82M":
                # Try to load the kokoro model type
                self.model = load_model("kokoro")
            else:
            ...
            return {"error": f"Model type kokoro not supported: {str(e)}"}
